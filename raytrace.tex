...
\def\createimage@do#1#2{{%
    ...
    \@calc@ray@trace#1#2(\@c@x,\@c@y)\@tmp@rgb@i%
    \edef\@c@x{\fpeval{(\c@x + rand() - 0.5) / \pictWidth}}%
    \edef\@c@y{\fpeval{(\c@y + rand() - 0.5) / \pictHeight}}%
    \@calc@ray@trace#1#2(\@c@x,\@c@y)\@tmp@rgb@ii%
    \edef\@c@x{\fpeval{(\c@x + rand() - 0.5) / \pictWidth}}%
    \edef\@c@y{\fpeval{(\c@y + rand() - 0.5) / \pictHeight}}%
    \@calc@ray@trace#1#2(\@c@x,\@c@y)\@tmp@rgb@iii%
    \edef\@tmp@rgb{\fpeval{(\@tmp@rgb@i + \@tmp@rgb@ii + \@tmp@rgb@iii)/3}}%
